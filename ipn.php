...
// STEP 3 - Extract the data PayPal IPN has sent us, into local variables 
  ...
  $record_id	 	= $_POST['custom'];
	...
	'<br>' . $_POST['item_number'] .
	'<br>' . $_POST['payment_status'] .
	'<br>' . $_POST['mc_gross'] .
	'<br>' . $_POST['mc_currency'] .
    '<br>' . $_POST['txn_id'] .
    '<br>' . $_POST['receiver_mail'] .
    '<br>' . $_POST['payer_email'] .
    '<br>' . $_POST['custom'] .
	'<hr>';
    file_put_contents('/home/kirino/sexy/ipn.log', $data, FILE_APPEND | LOCK_EX);
